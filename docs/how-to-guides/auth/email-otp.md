...
See [Plunk Email Provider Guide](../integrations/plunk-email.md) for more configuration options.
...
- [Auth Module Reference](../../reference/auth-module.md) - Full auth configuration options
- [Create First User](./create-first-user.md) - User management guide
- [Plunk Email Provider Guide](../integrations/plunk-email.md) - Detailed Plunk setup
- [Configuration Reference](../../reference/configuration.md) - Complete configuration options
- [Release Notes v0.20.0](../../releases/v0.20.0-release-notes.md) - OTP plugin release details
