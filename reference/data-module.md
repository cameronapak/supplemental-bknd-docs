...
- [Entity Relationships](/how-to-guides/data/entity-media-relationships) - Working with entity relationships
- [Database Indices](/orm) - Indexing for performance
- [Query System](/query-system) - Advanced query patterns
- [Schema IDs vs UUIDs](/how-to-guides/data/schema-ids-vs-uuids) - Primary key configuration

## Related Guides

- [Build Your First API](/getting-started/build-your-first-api) - Learn through hands-on tutorial
- [Seed Database](/how-to-guides/data/seed-database) - Populate initial data
- [Choose Your Mode](/how-to-guides/setup/choose-your-mode) - Configuration modes overview
- [Entity-Media Relationships](/how-to-guides/data/entity-media-relationships) - Media file associations
