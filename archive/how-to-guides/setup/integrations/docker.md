...
- **Database Configuration**: Learn more about database options in the [Choose Your Mode](/choose-your-mode) guide
- **Production Deployment**: See the [Deploy to Production](/../getting-started/deploy-to-production) tutorial
