...
- [Add Authentication with Permissions Tutorial](/getting-started/add-authentication)
- [Email OTP Authentication Guide](/how-to-guides/auth/email-otp)
- [Enable Public Access with Guard Guide](/how-to-guides/auth/public-access-guard)
- [Create First User Guide](/how-to-guides/auth/create-first-user)
